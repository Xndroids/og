...
command_list = ['start', 'users','fcast', 'pcast', 'byt','ryt','lyt','premium','remove', 'broadcast', 'batch', 'genlink', 'help', 'cmd', 'info', 'top', 'search', 'weekly','add_fsub', 'fsub_chnl', 'restart', 'del_fsub', 'add_admins', 'del_admins', 'admin_list', 'cancel', 'auto_del', 'forcesub', 'files', 'add_banuser', 'del_banuser', 'banuser_list', 'status', 'req_fsub', 'token', 'top', 'weekly', 'search']
